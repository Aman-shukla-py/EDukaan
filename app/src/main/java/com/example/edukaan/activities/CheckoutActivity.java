...
import com.example.edukaan.databinding.ActivityCheckoutBinding;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentUserEmail=findViewById(R.id.emailBox);
    ...
    void processOrder() {
        ...
        try {
            ...
            productOrder.put("userId",binding.emailBox.getText().toString());
                                ...
                                .setPositiveButton("Pay Now", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        new AlertDialog.Builder(CheckoutActivity.this)
                                                ...
                                                .setCancelable(false)
                                                .setNegativeButton("Check Order", new DialogInterface.OnClickListener() {
                                                    @Override
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        Intent intent = new Intent(CheckoutActivity.this, Order_History_Activity.class);
